...
public class InvModel {
    ...
    public static void add(Item item, int meta, String name, String variant) {
        System.out.println("models " + name + " is being registered");
    ...
    public static void register() {
        ...
        System.out.println("models registry is called");

        for(InvModel invmodel : models){
            System.out.println("Registering models: " + invmodel.meta + "-"+ invmodel.item.getRegistryName() + "-" + invmodel.item.getUnlocalizedName() + "-" + invmodel.variant);
