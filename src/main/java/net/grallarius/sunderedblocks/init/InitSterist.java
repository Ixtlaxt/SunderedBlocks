...
public class InitSterist {
    ...
    public static final Block stone_sterist_dark_raw_slab = ModBlocks.register("stone_sterist_dark_raw_slab", new BlockVertslab(Block.Properties.from(stone_sterist_dark_raw_block)));
