...
public class InitSterist {
    ...
    public static final Block stone_sterist_dark_quartslab = ModBlocks.register("stone_sterist_dark_quartslab", new BlockQuartslab(Block.Properties.from(stone_sterist_dark_cut_block)));
    public static final Block stone_sterist_pale_quartslab = ModBlocks.register("stone_sterist_pale_quartslab", new BlockQuartslab(Block.Properties.from(stone_sterist_pale_cut_block)));
    
    public static final Block stone_sterist_gravel = ModBlocks.register("stone_sterist_gravel", new GravelBlock(Block.Properties.create(Material.SAND, MaterialColor.STONE).hardnessAndResistance(0.6F).sound(SoundType.GROUND)));

    public static final Item stone_sterist_rubble = ModItems.register("stone_sterist_rubble");
