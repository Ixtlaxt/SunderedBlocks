...
public class SlotSaw extends SlotItemHandler
    {

    private final IItemHandler itemHandler;
    private final int index;

    public SlotSaw(IItemHandler itemHandler, int index, int xPosition, int yPosition){
    ...
    public boolean isItemValid(@Nonnull ItemStack stack)
    {
        ...
        Boolean isSaw = item instanceof ItemSaw;
